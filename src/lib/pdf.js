...
<body>
  ...
  <div class="cover-page">
    ...
    <div class="property-details">
      ...
      <div class="property-row">
        ...
        <span class="property-value">${escapeHtml(report.propertyType)}</span>
      </div>
      ` : ''}
      ${report.developerName ? `
      <div class="property-row">
        <span class="property-label">Developer:</span>
        <span class="property-value">${escapeHtml(report.developerName)}</span>
      </div>
      ` : ''}
      <div class="property-row">
  ...
  <div class="page">
    ...
    <p style="margin-bottom: 15px;">
      This snagging inspection was conducted on ${formatDate(report.inspectionDate)} at 
      ${escapeHtml(report.propertyAddress)}. The inspection identified 
      <strong>${report.snags.length} defects</strong> requiring attention.
    </p>
    ...
    <table class="summary-table">
      ...
      ${Object.entries(snagsByRoom).map(([room, snags]) => `
      <tr>
    ...
    <table class="summary-table">
      ...
      ${Object.entries(groupSnagsByTrade(report.snags)).map(([trade, snags]) => `
      <tr>
  ...
  <div class="page">
    ...
    ${Object.entries(snagsByRoom).map(([r
